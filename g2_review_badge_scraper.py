...
with SB(uc=True) as sb:
    for index, productLink in enumerate(
        productsLinks[last_index:], start=last_index + 2
    ):
        ...
        try:
            ...
            company_data = {"Product Link": productLink, "Badge": badge}
            ...
            df.to_csv(
                ...
                mode="a",
                index=False,
                header=not os.path.exists(new_csv_file),
            )
